...
5.  A Loomis-Wood plot named "Plot0" will be created automatically.
    ...
    Loomis-Wood folder by selecting **Loomis-Wood | Plots | Create a New Loomis-Wood Plot...**.
    A dialog box will ask you for the Loomis-Wood folder containing the data for the plot,
    and a name for the subfolder that will contain data specific to the new Loomis-Wood plot.
...
7.  Now, we need to find some constants that will make the display meaningful.
    ...
    Right click on the marquee and choose Horiz Expand to zoom in on this region.
